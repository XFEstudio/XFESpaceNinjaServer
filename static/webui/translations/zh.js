...
dict = {
    ...
    code_feature_1: `Orokin 反应堆`,
    code_feature_1_alt: `Orokin 催化剂`,
    code_feature_2: `扩展槽位`,
    code_feature_4: `反重力适配器`,
    code_feature_8: `镀金`,
    code_feature_32: `赋能槽位`,
    code_feature_64: `次要赋能槽位`,
    code_feature_1024: `覆写槽位`,
    login_description: `使用您的 XFEstudio-OpenWF 账户凭证登录(与游戏内连接本服务器时使用的昵称相同)`,
    ...
    inventory_addItemByItemType: `根据物品编号添加物品`,
    inventory_addItemByItemType_warning: `警告: 这种方法可能会导致添加重复的物品，从而引发游戏内问题。请谨慎使用！`,
    inventory_suits: `战甲`,
    ...
    inventory_bulkAddFlavourItems: `添加缺失的装饰物品`,
    inventory_bulkAddShipDecorations: `添加缺失的飞船装饰`,
    inventory_bulkAddEvolutionProgress: `添加缺失的灵化之源进度`,
    inventory_bulkAddWeaponSkins: `添加缺失的武器外观`,
    ...
    detailedView_umbraEchoesExpiryLabel: `Umbra过期时效(可选)`,
    ...
    cheats_administratorRequirement: `您必须是管理员才能使用此功能.要成为管理员,请在加入群聊<a href="https://qm.qq.com/q/uYW2MrRFo4">点击加入</a>并联系管理员.`,
    cheats_server: `服务器`,
    ...
    worldState_evilBaroStage: `邪恶Baro阶段`,
    ...
    guildView_vaultMiscItems: `杂项物品`,
    guildView_vaultShipDecorations: `道场装饰`,
    ...
    guildView_bulkAddTechProjects: `添加缺失研究`,
    guildView_bulkAddVaultDecoRecipes: `添加缺失道场装饰配方`,
    guildView_bulkAddVaultShipDecorations: `添加缺失道场装饰`,
    guildView_bulkFundTechProjects: `资助所有研究`,
    guildView_bulkCompleteTechProjects: `完成所有研究`,
